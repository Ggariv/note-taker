...
The application’s front end has already been created. It's your job to build the back end, connect the two, and then deploy the entire application to [heroku](https://dashboard.heroku.com/apps/gg-note-taker).

[heroku-link](https://gg-note-taker.herokuapp.com/) 
